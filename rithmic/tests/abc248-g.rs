#![feature(array_windows, box_patterns, box_syntax, decl_macro, exclusive_range_pattern, half_open_range_patterns, int_log, int_roundings, let_else, map_first_last, rustc_attrs)]
