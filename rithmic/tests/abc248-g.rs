#![feature(array_windows, box_patterns, box_syntax, decl_macro, exclusive_range_pattern, explicit_generic_args_with_impl_trait, half_open_range_patterns, int_log, int_roundings, label_break_value, let_chains, let_else, map_first_last, rustc_attrs)]
