...
impl<T, O: MonoidOps<T, T>> NdFenwick<14, T, O>
where T: Default
{
    pub fn update(&mut self, index: [usize; 14], value: T)
    {
                                                    ...
                                                    while i2 < self.shape()[2] {
                                                        ...
                                                        while i1 < self.shape()[1] {
                                                            ...
                                                            while i0 < self.shape()[0] {
                                                                let index = [i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13];
